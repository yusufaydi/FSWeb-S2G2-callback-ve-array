...
//helper functions
const Finaller = function(){
    const allFinals = fifaData.filter(match => match.Stage === "Final");
    return allFinals;
}
const Yillar = function(){
    return Finaller(fifaData).map(item => item.Year);
}
const Kazananlar = function(){
    return Finaller(fifaData).map(match => match["Home Team Goals"] > match["Away Team Goals"] ? match["Home Team Name"] : match["Away Team Name"])
}
describe('saFunction', ()=>{
    it('sa, as döndürüyor', ()=>{
...
//task 2:
describe('Finaller', ()=>{
    it('Finaller, final maçlarını içeren diziyi döndürüyor', ()=>{
        expect(functions.Finaller(fifaData)).toEqual(expect.arrayContaining(
            [
                {
                  Year: 1930,
...
// task 3
describe('Yillar', ()=>{
    it('yılları içeren bir dizi', ()=>{
        expect(functions.Yillar(fifaData, Finaller)).toEqual(expect.arrayContaining(
            [
                1930, 1934, 1938, 1954,
                1958, 1962, 1966, 1970,
                1974, 1978, 1982, 1986,
...
describe('Kazananlar', ()=>{
    it('tüm kazananları döndüren bir dizi döndürüyor', ()=>{
        expect(functions.Kazananlar(fifaData, Finaller)).toEqual(expect.arrayContaining(
            [
                'Uruguay',    'Italy',
                'Italy',      'Germany FR',
                'Brazil',     'Brazil',
...
describe('YillaraGoreKazananlar', ()=>{
    it('kazananların ismini içeren bir dizi döndürüyor', ()=>{
        expect(functions.YillaraGoreKazananlar(fifaData, Finaller, Yillar, Kazananlar)).toEqual(expect.arrayContaining(
            [
                '1930 yılında, Uruguay dünya kupasını kazandı!',
                '1934 yılında, Italy dünya kupasını kazandı!',
                '1938 yılında, Italy dünya kupasını kazandı!',
                '1954 yılında, Germany FR dünya kupasını kazandı!',
                '1958 yılında, Brazil dünya kupasını kazandı!',
                '1962 yılında, Brazil dünya kupasını kazandı!',
                '1966 yılında, England dünya kupasını kazandı!',
                '1970 yılında, Brazil dünya kupasını kazandı!',
                '1974 yılında, Germany FR dünya kupasını kazandı!',
                '1978 yılında, Argentina dünya kupasını kazandı!',
                '1982 yılında, Italy dünya kupasını kazandı!',
                '1986 yılında, Argentina dünya kupasını kazandı!',
                '1990 yılında, Germany FR dünya kupasını kazandı!',
                '1994 yılında, Italy dünya kupasını kazandı!',
                '1998 yılında, France dünya kupasını kazandı!',
                '2002 yılında, Brazil dünya kupasını kazandı!',
                '2006 yılında, France dünya kupasını kazandı!',
                '2010 yılında, Spain dünya kupasını kazandı!',
                '2014 yılında, Germany dünya kupasını kazandı!'
              ]
        ));
    })
});
...
describe('OrtalamaGolSayisi', ()=>{
    it('OrtalamaGolSayisi bir sayı döndürüyor', ()=>{
        expect(functions.OrtalamaGolSayisi(Finaller(fifaData))).toBe('3.58');
    })
});
